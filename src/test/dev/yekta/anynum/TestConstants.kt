...
internal const val INDEX_STRINGS_MX = 0
internal const val INDEX_STRINGS_EN = 1
...
internal val strings = listOf(
    listOf(
        ...
        "", // [1] -> English numbers (INDEX_STRINGS_EN)
        "", // [2] -> Arabic numbers  (INDEX_STRINGS_AR)
        "", // [3] -> Persian numbers (INDEX_STRINGS_FA)
    ),
    listOf(
        "۱۲۳456٧٨٩0",
        "1234567890",
